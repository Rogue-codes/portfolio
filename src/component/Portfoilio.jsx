    ...
    return (
        <section className='portfolio' id='portfolio'>
            ...
            <div className="container">
                <a href="https://sa-market.netlify.app/" target="_blank" className="left" data-aos="fade-right">
                    <div>
            ...
            <div className="container2">
                ...
                <a href="https://healthpro.netlify.app/" target="_blank" className="left" data-aos="fade-left">
                    <div>
                        <div className="shadow"></div>
            ...
            <div className={isClicked ? "others auto" : "others"}>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://backtocollege.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://cloudther.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://orangebank.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://bluebirdcmast.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://minnatoexchange.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://lexus-clone.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://nettflixx-clone.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://arfimuzik.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://payzone.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://techypoint.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
                ...
                <div className="cards" data-aos="fade-up">
                    ...
                    <FolderOutlined className="file"/>
                    <a href="https://github.com/Rogue-codes" target="_blank" className="git"><GitHub/> </a>
                    <a href="https://rogue-movies.netlify.app/" target="_blank" className="url"><Link/></a>
                </div>
            </div>
